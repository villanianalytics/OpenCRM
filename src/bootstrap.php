...
function app_settings(bool $refresh=false): array {
    ...
    if ($settings === null) {
        $settings = ['app_name'=>'OpenCRM','primary_color'=>'#1565c0','accent_color'=>'#43a047','logo_path'=>'','logo_mime'=>'','logging_level'=>'info','app_timezone'=>'America/New_York','mail_transport'=>'local','mail_from_address'=>'','mail_from_name'=>'','smtp_host'=>'','smtp_port'=>'587','smtp_encryption'=>'tls','smtp_username'=>'','smtp_password_enc'=>'','openai_api_key_enc'=>'','openai_model'=>'gpt-5.4-mini','booking_engine'=>'native','easyappointments_url'=>'','easyappointments_api_token_enc'=>'','google_calendar_client_id'=>'','google_calendar_client_secret_enc'=>'','microsoft_calendar_client_id'=>'','microsoft_calendar_client_secret_enc'=>'','microsoft_calendar_tenant'=>'common','stripe_secret_key_enc'=>'','stripe_webhook_secret_enc'=>'','stripe_enabled'=>'0'];
        try {
