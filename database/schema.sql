...
CREATE TABLE IF NOT EXISTS contacts (
 ...
 address TEXT NULL, website VARCHAR(255) NULL, linkedin_url VARCHAR(500) NULL, active BOOLEAN NOT NULL DEFAULT TRUE, created_by BIGINT UNSIGNED NULL, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS reminders (
 ...
 message TEXT NOT NULL, due_at DATETIME NOT NULL, recurrence_days SMALLINT UNSIGNED NULL, completed_at DATETIME NULL, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
 FOREIGN KEY(contact_id) REFERENCES contacts(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS sites (
 ...
 retention_days SMALLINT UNSIGNED NOT NULL DEFAULT 365, robots_extra TEXT NULL, search_console_verification VARCHAR(255) NULL, created_by BIGINT UNSIGNED NULL, updated_by BIGINT UNSIGNED NULL,
 created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
 FOREIGN KEY(created_by) REFERENCES users(id) ON DELETE SET NULL, FOREIGN KEY(updated_by) REFERENCES users(id) ON DELETE SET NULL
) ENGINE=InnoDB;
...
CREATE TABLE IF NOT EXISTS site_redirects (
 id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY, site_id BIGINT UNSIGNED NOT NULL, source_path VARCHAR(500) NOT NULL,
 target_url VARCHAR(2000) NOT NULL, http_status ENUM('301','302') NOT NULL DEFAULT '301', active BOOLEAN NOT NULL DEFAULT TRUE,
 created_by BIGINT UNSIGNED NULL, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
 UNIQUE(site_id,source_path), FOREIGN KEY(site_id) REFERENCES sites(id) ON DELETE CASCADE,
 FOREIGN KEY(created_by) REFERENCES users(id) ON DELETE SET NULL
) ENGINE=InnoDB;
CREATE TABLE IF NOT EXISTS site_pages (
 id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY, site_id BIGINT UNSIGNED NOT NULL, name VARCHAR(190) NOT NULL,
 slug VARCHAR(160) NOT NULL, title VARCHAR(255) NULL, meta_description VARCHAR(500) NULL, canonical_url VARCHAR(2000) NULL,
 social_title VARCHAR(255) NULL, social_description VARCHAR(500) NULL, social_image_url VARCHAR(2000) NULL, noindex BOOLEAN NOT NULL DEFAULT FALSE, structured_data_json JSON NULL,
...
CREATE TABLE IF NOT EXISTS site_assets (
 id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY, site_id BIGINT UNSIGNED NULL, original_name VARCHAR(255) NOT NULL,
 stored_name VARCHAR(255) NOT NULL UNIQUE, mime_type VARCHAR(120) NOT NULL, byte_size BIGINT UNSIGNED NOT NULL,
 alt_text VARCHAR(500) NULL, created_by BIGINT UNSIGNED NULL, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
 FOREIGN KEY(site_id) REFERENCES sites(id) ON DELETE CASCADE, FOREIGN KEY(created_by) REFERENCES users(id) ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS email_threads (
 id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY, contact_id BIGINT UNSIGNED NOT NULL, opportunity_id BIGINT UNSIGNED NULL,
 subject VARCHAR(500) NOT NULL, assigned_user_id BIGINT UNSIGNED NULL, status ENUM('open','closed') NOT NULL DEFAULT 'open',
 unread_count INT UNSIGNED NOT NULL DEFAULT 0, last_message_at DATETIME NULL, created_by BIGINT UNSIGNED NULL,
 created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
 FOREIGN KEY(contact_id) REFERENCES contacts(id) ON DELETE CASCADE, FOREIGN KEY(opportunity_id) REFERENCES opportunities(id) ON DELETE SET NULL,
 FOREIGN KEY(assigned_user_id) REFERENCES users(id) ON DELETE SET NULL, FOREIGN KEY(created_by) REFERENCES users(id) ON DELETE SET NULL,
 INDEX(assigned_user_id,status,last_message_at), INDEX(contact_id,last_message_at)
) ENGINE=InnoDB;
CREATE TABLE IF NOT EXISTS email_messages (
 id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY, thread_id BIGINT UNSIGNED NOT NULL, direction ENUM('inbound','outbound') NOT NULL,
...
CREATE TABLE IF NOT EXISTS email_mailboxes (
 id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY, name VARCHAR(190) NOT NULL, from_name VARCHAR(190) NULL,
